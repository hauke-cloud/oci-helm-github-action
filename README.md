...
# oci-helm-github-action


<img src="https://raw.githubusercontent.com/hauke-cloud/.github/main/resources/img/organisation-logo-small.png" alt="hauke.cloud logo" width="109" height="123" align="right">


Provides a GitHub Action to build OCI images and package and push Helm charts to OCI registries

This chart offers you:
- Github Action to build OCI images
...
```bash
git clone https://github.com/hauke-cloud/oci-helm-github-action.git
```
...
```bash
helm template oci://ghcr.io/hauke-cloud/charts/oci-helm-github-action
```

#### Deploy the Helm chart

```bash
helm install oci-helm-github-action oci://ghcr.io/hauke-cloud/charts/oci-helm-github-action --version 1.0.0
```
